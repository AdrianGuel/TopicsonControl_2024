...
%March 2024
%Optimal control for cart in one dimension using fmincon function. The code requires to define cost.m
...
best_control=fmincon(@(gains) cost(gains,50,[m,b]), [5,5], [], [], [], [], [0,-b], [10,10])
kp=best_control(1);
kd=best_control(2);
